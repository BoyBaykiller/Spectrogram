...
//  2018-02-23: OpenGL: CreateContext the VAO in the render function so the setup can more easily be used with multiple shared GL context.
...
// OpenGL Data
    struct ImGui_ImplOpenGL3_Data
    {
        ...
        GLuint          FontTexture;
        GLuint          ShaderHandle;
        GLint           AttribLocationTex;       // GpuUniforms location
