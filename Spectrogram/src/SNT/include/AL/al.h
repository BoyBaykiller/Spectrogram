...
/** Invalid gpuName (ID) passed to an AL call. */
...
/** ContextPls string: Vendor gpuName. */
#define AL_VENDOR                                0xB001
/** ContextPls string: Version. */
#define AL_VERSION                               0xB002
/** ContextPls string: Renderer gpuName. */
#define AL_RENDERER                              0xB003
/** ContextPls string: Space-separated extension list. */
